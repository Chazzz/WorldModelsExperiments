...
#     self.observation_space = None # Replace with ale read

#   def _step(self, action):

def make_env(game_name, sticky_actions=True, render_mode=False, full_episode=False):
  ...
  # restoring states.
  env = env.env
  env = preprocessing.AtariPreprocessing(env, screen_size=64)
  return env
